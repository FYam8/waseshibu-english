...
assert.equal(manifest.consumerContractV11,true);
assert.equal(manifest.status,'production-waseda-commonized');
assert.equal(manifest.productionBehaviorDelegation,true);

...
const scripts=['data.js','paper-underlines.js','manual-guides.js','extra-drills.js','detail-drills-v2.js','learning-model.js','original-drills-loop3.js','original-drills-loop4.js','ui/exam-session.js','ui/answer-widgets.js','ui/today-presenter.js','app.js']
...
assert.match(html,/application-version" content="0\.20\.0"/)
